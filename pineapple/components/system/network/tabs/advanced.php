...
<fieldset>
    ...
    <form method="POST" action="/components/system/network/functions.php?change_hostname" onsubmit="$(this).AJAXifyForm(update_message); return false;">
        <table>
            <tr><td>Hostname: </td><td><input type='text' name='hostname' value='<?=exec('uci get system.@system[0].hostname')?>'></td></tr>
