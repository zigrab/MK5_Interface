...
<fieldset>
  <legend>Route<help id='network:route'></help> - <a href="#sys/network/restart_dns/true/notify">Restart DNS</a></legend>
  <?php
  exec('route', $route);
  echo '<pre>';
...
<fieldset>
  <legend>Ifconfig<help id='network:ifconfig'></help></legend>
  <?php
