...
<fieldset>
  ...
  Flashing a firmware upgrade will wipe all data on your pineapple. It will not wipe the SD card, but please make sure you have one inserted.<br />
  ...
  Additionally, you should only perform a flash on a stable power connection, the wall adapter is recommended.<br />
