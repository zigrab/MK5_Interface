...
<fieldset>
    <legend>Webinterface Help<help id='configuration:webinterface_help'></help></legend>
    <form method='POST' action='/components/system/configuration/functions.php?display_help' onSubmit='$(this).AJAXifyForm(update_help); return false;'>
        <table>
            <tr><td>Display help:</td><td><input type='checkbox' name='show_help' <?=(file_exists('/pineapple/includes/css/disable_help')) ?  '' : 'checked'?>></td></tr>
