...
if (isset($_GET['display_help'])) {
    if (isset($_POST['show_help'])) {
        @unlink('/pineapple/includes/css/disable_help');
        echo "<span class='success'>Help enabled. Please <a href='/'>refresh the webinterface.</a></span>";
    } else {
        @touch('/pineapple/includes/css/disable_help');
        echo "<span class='success'>Help disabled. Please <a href='/'>refresh the webinterface.</a></span>";
    }
}
